...
<p class="has-cordyceps-color has-text-color has-xs-font-size" style="margin-bottom:var(--wp--preset--spacing--40);font-weight:700;letter-spacing:0.08em;text-transform:uppercase">Hongos funcionales</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"fontSize":"xxxl"} -->
<h1 class="wp-block-heading has-xxxl-font-size">Cordyceps, Hericium y Trametes en tres formatos</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"grafito","fontSize":"md","style":{"spacing":{"margin":{"top":"var:preset|spacing|45","bottom":"var:preset|spacing|55"}}}} -->
<p class="has-grafito-color has-text-color has-md-font-size" style="margin-top:var(--wp--preset--spacing--45);margin-bottom:var(--wp--preset--spacing--55)">Chocolate, tisana y capsula. Cada empaque lleva su codigo de lote y la ficha completa de lo que hay dentro.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( home_url( '/politica-de-envios/' ) ); ?>">Como enviamos</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
